package com.ludoven.base.utils
...
class ActivityManager private constructor() : ActivityLifecycleCallbacks {
    ...
    override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
        Log.i("onActivityCreated","%s - onCreate    "+ activity.javaClass.simpleName)
        if (activitySet.size == 0) {
            ...
            Log.i("onActivityCreated","%s - onApplicationCreate  "+activity.javaClass.simpleName)
        }
    ...
    override fun onActivityStarted(activity: Activity) {
        Log.i("onActivityStarted","%s - onStart "+activity.javaClass.simpleName)
    }

    override fun onActivityResumed(activity: Activity) {
        Log.i("onActivityResumed","%s - onResume    "+ activity.javaClass.simpleName)
        if (topActivity === activity && resumedActivity == null) {
            for (callback: ApplicationLifecycleCallback in lifecycleCallbacks) {
                callback.onApplicationForeground(activity)
            }
            Log.i("onActivityResumed","%s - onApplicationForeground "+ activity.javaClass.simpleName)
        }
        topActivity = activity
    ...
    override fun onActivityPaused(activity: Activity) {
        Log.i("onActivityPaused","%s - onPause "+ activity.javaClass.simpleName)
    }

    override fun onActivityStopped(activity: Activity) {
        Log.i("onActivityStopped","%s - onStop  "+ activity.javaClass.simpleName)
        ...
        if (resumedActivity == null) {
            ...
            Log.i("onActivityStopped","%s - onApplicationBackground "+activity.javaClass.simpleName)
        }
    }

    override fun onActivitySaveInstanceState(activity: Activity, outState: Bundle) {
        Log.i("onActivitySave","%s - onSaveInstanceState "+ activity.javaClass.simpleName)
    }

    override fun onActivityDestroyed(activity: Activity) {
        Log.i("onActivitySave","%s - onDestroy   "+activity.javaClass.simpleName)
        ...
        if (activitySet.size == 0) {
            ...
            Log.i("onActivitySave","%s - onApplicationDestroy    "+ activity.javaClass.simpleName)
        }
    }
